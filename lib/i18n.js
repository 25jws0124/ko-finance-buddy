...
export const STRINGS = {
  ko: {
    ...
    uploadLabel: '사진 올리기',
    uploadNote: '촬영하거나 저장된 사진을 고를 수 있어요 · 사진은 저장하지 않고 바로 지웁니다',
  ...
  en: {
    ...
    uploadNote: 'Take a photo or pick a saved one · the photo is deleted right away',
  ...
  vi: {
    ...
    uploadNote: 'Chụp mới hoặc chọn ảnh đã lưu · ảnh sẽ bị xóa ngay',
